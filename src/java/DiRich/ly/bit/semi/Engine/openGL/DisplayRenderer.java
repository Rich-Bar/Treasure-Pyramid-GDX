...
public class DisplayRenderer {
	...
	public void start(){
		...
		while (!Display.isCloseRequested()) {
		    ...
		    GL11.glColor4f(1.5f,0.5f,0.0f, 1.0f);
	...
	public void setDisplay(int width, int height, boolean fullscreen){
		...
		if((double)screenDimension.width / screenDimension.height < (double)width / height){
			double f = (double)height / screenDimension.height;
			offsetX = (int) ((width - screenDimension.width * f) /2);
		}else if((double)screenDimension.width / screenDimension.height > (double)width / height){
			double f = (double)width / screenDimension.width;
			offsetY = (int) ((height - screenDimension.height * f) /2);
		}
		System.out.println("offsetX: " + offsetX + " - offsetY: " + offsetY);
		
		GL11.glOrtho(-offsetX ,screenDimension.width + offsetX, screenDimension.height + offsetY, - offsetY, 1, -1);

...
public class Sound{
	 ...
	 */
	public void playMusic(float pitch, float volume) {
	 ...
	 */
	public void playEffect(float x, float y, float z) {
		playEffect(1.0f, 1.0f, x,y,z);
	}
	 ...
	 * @param z The z position of the source of the effect
	 */
	public void playEffect(float pitch, float volume, float x, float y, float z) {
	 ...
	 * @param volume The volumen to play the sound effect at
	 */
	public void playLoop(float pitch, float volume) {
	...
	public void playAt(float pitch, float volume, float pos){
